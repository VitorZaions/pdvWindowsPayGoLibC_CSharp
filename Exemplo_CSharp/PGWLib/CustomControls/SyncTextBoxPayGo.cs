...
namespace CustomControls.SyncControls
{
    ...
    public partial class SyncTextBoxPayGo : UserControl
    {
        #region -> Fields
        //Fields
        ...
        private TextoTipoPayGo tipoTexto;
        ...
        [Category("SyncTextBox")]
        public TextoTipoPayGo TipoDeTexto
        {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                if (this.TipoDeTexto == TextoTipoPayGo.TextoInteger)
                {
        ...
        private void textBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (this.TipoDeTexto == TextoTipoPayGo.TextoInteger && !char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true; // Ignora o caractere
            }
            else if (this.TipoDeTexto == TextoTipoPayGo.TextoDouble)
            {
