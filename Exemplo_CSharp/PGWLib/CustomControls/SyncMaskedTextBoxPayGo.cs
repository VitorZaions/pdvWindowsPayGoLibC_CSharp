...
{
    public partial class SyncMaskedTextBoxPayGo : UserControl
    {
        ...
        public SyncMaskedTextBoxPayGo()
        {
            ...
            TextBoxMask.TextChanged += new EventHandler(TextBox_TextChanged);//Default event
